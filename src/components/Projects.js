...
const Projects = () => {
    ...
    const arrayProjects = [
        ...
        },
        {
            ...
            hashtags: '#HTML  #CSS  #Bootstrap  #JavaScript  #React  #ReactFastMarquee  #Mercadopago  #Node  #Express.js  #JWT  #MongoDB  "#CORS  #AXIOS  #Redux  #Heroku  #GoogleApis',
        ...
        },
        {
            ...
            hashtags: '#HTML  #CSS  #Bootstrap  #JavaScript  #React  #Marquee #Petshop  #SweetAlert  #AXIOS  #gitpages ',
            miniatures: ["http://drive.google.com/uc?export=view&id=1eDvDPdYCLQ1VqwF21-hHjBUixY658MYO", "http://drive.google.com/uc?export=view&id=1TCHzbUFZyuubkkOt_Q1oVGQalTq6jKb4", "http://drive.google.com/uc?export=view&id=1vY_5RREDLRdvyoOs_JcolfAa_mk-0X_R", "http://drive.google.com/uc?export=view&id=1vSP62-2FBN97v9d9KBxBAiWaI5PptDoB", "http://drive.google.com/uc?export=view&id=1oHKCSkbN2D7pc5DiKNb1sjSkui8QgSGZ", "http://drive.google.com/uc?export=view&id=15esdb0qIdS2veo7iZFm-1bs0-zpBphDo"],
            logoSites: [{
        ...
        },
        {
            ...
            hashtags: '#HTML  #CSS  #Bootstrap  #JavaScript  #React  #Firebase #AXIOS #CarContext  #Vercel.app  #GoogleFirebase',
            miniatures: ["http://drive.google.com/uc?export=view&id=1uJHIDp4SgB5MggaI1OWZziRe4DUyYRiM","http://drive.google.com/uc?export=view&id=1WejGbMS7Wu0wzfI0mfJU1LmXANijULST", "http://drive.google.com/uc?export=view&id=1bFXxXXFUCVo1rkKIu8uUsLJSHQUT7L6e", "http://drive.google.com/uc?export=view&id=19JtPL8JUZfY7P8JyOgZdQ0HMGCu0quaL", "http://drive.google.com/uc?export=view&id=1RNoprRg4x5TsLgcZEgj7-RAP_xpqp2zu", "http://drive.google.com/uc?export=view&id=12ymsIkjWFKc1HqT03BswsrdVe1wR9sOd", "http://drive.google.com/uc?export=view&id=1-N7a30nNlANEe_lc6Fk4r2cC5onoDEJQ"],
            logoSites: [{
        ...
        },
        {
            ...
            hashtags: '#HTML  #CSS  #Bootstrap  #JavaScript  #gitPages #AXIOS #Glassmorphism  ',
            miniatures: ["http://drive.google.com/uc?export=view&id=1mfXCEEKtMum-Dd7vljQwKG04ErCWGcIQ", "http://drive.google.com/uc?export=view&id=1D8anUTd6FtsLhLNlq9ukbdy2SsTYhSUp", "http://drive.google.com/uc?export=view&id=1zndNrsyXBu4_WmjXfi0M_IwFBI-Zs_aF", "http://drive.google.com/uc?export=view&id=12ZD2Dt1BdVYYPG9ydpK9rNLzJfxS4HlM","http://drive.google.com/uc?export=view&id=1Hhhc7uWm3EJYDuaQXzxfAtJvABAAOoy_", "http://drive.google.com/uc?export=view&id=1EIO8cVKQJ1sKj5H0ZYjxW_9txyKbjguF", "http://drive.google.com/uc?export=view&id=1A_fKAIOYuEBobTH9JR_4eKegLgTm-4xi" ],
            logoSites: [{
        ...
        },
        {
            ...
            hashtags: '#HTML  #CSS  #Bootstrap  #JavaScript  #MetaMask  #WEB3 #shop #FoodRecipe #Jquery #SASS #API #moralis ',
            miniatures: ["http://drive.google.com/uc?export=view&id=12K8EkqG1bQpmnKxUyB52Ey-dNOWTGlY3", "http://drive.google.com/uc?export=view&id=10bdOpA1l7XkK24ahrdSBlE0VUbqmVD6C", "http://drive.google.com/uc?export=view&id=14EWozy7YQXvRtYOaEpbzndvgx1T_sJLg", "http://drive.google.com/uc?export=view&id=1tsA1CJemqijItxj5Qa9z_klKFrPpEU21", "http://drive.google.com/uc?export=view&id=11aR5c2drK2cp6a9t_E6JQfYRbUA0Ba_D", "http://drive.google.com/uc?export=view&id=1cTBabtPG9AENNUWtsxMclH4VGF-HkMEL"],
            logoSites: [{
        ...
        },
        {
            ...
            hashtags: '#HTML  #CSS  #Bootstrap  #JavaScript  #MetaMask  #WEB3  #NFT #Staking #Jquery #SASS ',
            miniatures: ["http://drive.google.com/uc?export=view&id=1-bTDA5CKNJ15K8jElKnMRtHHDGTXSyXY", "http://drive.google.com/uc?export=view&id=1KfemzzcQIu_au-WW_ZRbxg4r8UkzJIsn", "http://drive.google.com/uc?export=view&id=1_eZtdd19wu117Byg3Q5fJ-68W3RFwe7t", "http://drive.google.com/uc?export=view&id=1G366FWGDqRocJ0GUxVJWxAlVJ6NUQmhL", "http://drive.google.com/uc?export=view&id=1-ajbR1TDm9YJMrQAizHEEgDMdioqR5O9"],
            logoSites: [{
                    ...
                    return (
                        <div className='div-card-project m-3' key={p.id} >
                            ...
                            <div className='d-flex flex-column align-items-center'>
                                ...
                                <Marquee className="marquee-div w-100 py-4" gradient={false} speed={15} direction={'right'} >
                                    {
                                        p.miniatures.map((i) => <img onClick={()=>handleImg(i)} className='mini-img-project' src={i} alt={i} />)
                                    }
                                </Marquee>
