    ...
    <div className="App">
      <nav className="navbar pt-3">
        <div className="container d-flex justify-content-center gap-5 div-nav  ">
          ...
          <a className="navbar-brand" href="#training">Capacitación</a>
          <a className="navbar-brand" href="#projects">Proyectos</a>
          <a className="navbar-brand" href="#contactme">Contacto</a>
        </div>
      </nav>
      <header className="App-header">
        <div className='absolute'>
        </div>
        <video id='video' loop autoPlay muted infinite="true" >
